...
set fold_num	[lindex $argv 1]
set fold_name	"dir_$fold_num"

## Set the input and output directories
set direct		/scratch/ade110/Geo_again
set blast_split	$direct/BLAST/OUT_all_split
