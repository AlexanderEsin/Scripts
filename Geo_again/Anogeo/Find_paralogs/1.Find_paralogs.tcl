...
set direct /users/aesin/Desktop/Geo_again/Anogeo_analysis/Find_inparalogs
...
foreach blast_output $blast_out_files {
	...
	## Trim away self hits
	catch {exec /Users/aesin/Documents/Scripts/Geo_again/Anogeo/Find_paralogs/1.Trim_selfhits.R $out_path/$blast_output $direct/Self_trimmed}
