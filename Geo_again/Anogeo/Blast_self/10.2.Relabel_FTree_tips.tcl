...
set tree_dir		$direct/Family_groups/$trunc_eval/FastTree_tree
set bipart_file		$tree_dir/FT_tree_$trunc_eval\.txt
...
set out		[open $tree_dir/FT_tree_$trunc_eval\_relab.txt w]
...
file copy -force $tree_dir/FT_tree_$trunc_eval\_relab.txt $out_tree_dir
