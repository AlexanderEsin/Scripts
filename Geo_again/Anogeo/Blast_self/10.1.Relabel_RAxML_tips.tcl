...
set tree_dir		$direct/Family_groups/$trunc_eval/RAxML_tree
set bipart_file		$tree_dir/RAxML_bipartitions.super_tree$trunc_eval\.txt
...
set out		[open $tree_dir/Supertree_$trunc_eval\_relab.txt w]
puts $out	[string trim $relabel_tree]
close $out


## Also copy the relabelled tree into a seperate "tree" directory
file copy -force $tree_dir/Supertree_$trunc_eval\_relab.txt $out_tree_dir
