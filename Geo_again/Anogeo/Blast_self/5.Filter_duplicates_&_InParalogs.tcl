...
set mcl_groups_file	$mcl_group_dir/MCL_groups_$ival\_$trunc_eval\.txt
...
foreach paralog_pair $in_paralog_list {
	...
	set para_A_group_index	[lsearch -all $after_dupl_groups *\t$para_A*]
	set para_B_group_index	[lsearch -all $after_dupl_groups *\t$para_B*]
	...
	foreach group_index [concat $para_A_group_index $para_B_group_index] {
		...
		set group	[lindex $after_dupl_groups $group_index]
...
set after_masking_groups		$after_dupl_groups
