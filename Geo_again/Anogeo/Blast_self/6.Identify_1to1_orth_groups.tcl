...
set blast_in_dir	$direct/Blast_anogeo/Input
set input_proteomes	[glob $blast_in_dir/*fasta]

set all_taxids		{}

foreach proteome $input_proteomes {
	set file_name	[file tail $proteome]
	set acc_ass		[string range $file_name 0 end-15]
	
	set taxid		[db1 eval {select taxid from t1 where acc_ass = $acc_ass limit 1}]
