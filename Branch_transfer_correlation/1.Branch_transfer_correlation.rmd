...
# Plot the tree with edges coloured by the fraction #
col_ramp <- brewer.pal(n = 11, name = "Spectral")
palette <- colorRampPalette(col_ramp[2:6])(999)
palette <- c(rep("#000000", 1), rev(palette))


plotBranchbyTrait_AE(anoxy_geo_time, edge_raw_dfs$time$T5, method="edges", legend = .25, title = "Number of transfers", palette = palette)
