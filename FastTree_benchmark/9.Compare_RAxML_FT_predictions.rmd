...
RAX_const_HGT	<- read.table(file = "/Users/aesin/Desktop/FastTree/RAxML_outputs/Constant_events/HGT_full_tbl_t3_t4.tsv", sep = "\t", header = TRUE, stringsAsFactors = FALSE)
FT_const_HGT	<- read.table(file = "/Users/aesin/Desktop/FastTree/FastTree_outputs/Constant_events/HGT_full_tbl_t3_t4.tsv", sep = "\t", header = TRUE, stringsAsFactors = FALSE)
...
## Colours!
not_found_color	<- wes_palette("Moonrise1")[3]
found_colors	<- rev(wes_palette("Cavalcanti1"))[c(1,2,4,5)]
