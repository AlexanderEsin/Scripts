...
cd /users/aesin/desktop/Geo_analysis/Geo_omes/Genome_alignment/Geobac_genomes_gbff
genome_files=*
...
progressiveMauve --output=../Mauve_multi_align/Geobac_19way --disable-cache --output-guide-tree=../Geobac_guide_tree/19_way_geobac_guide_tree_mauve_gbff.txt $genome_files > ../Alignment_log.txt
