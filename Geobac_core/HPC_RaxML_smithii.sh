...
direct=$SCRATCH/RAxML/Geobac/First_out_smithii
cd $direct


echo 'set direct /scratch/ade110/RAxML/Geobac/First_out_smithii
...
foreach fam $fams {
	...
	exec raxml -f a -s $fam -n $fname.txt -m PROTCATDAYHOFF -p 1234 -x 10001 -N 1000 -T 16
}
