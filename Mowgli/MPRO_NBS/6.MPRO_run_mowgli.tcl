...
set input_directory Test_NBS/MPRO_input_$transfer_cost
# set input_directory MPRO_input_BS_FAILED_$transfer_cost
set failed_directory Test_NBS/MPRO_input_BS_FAILED_$transfer_cost
set success_directory Mow_NBS_out_t$transfer_cost

###########################################################################

set input_path $direct/$input_directory
set failed_path $direct/$failed_directory
set temp_output_path $direct/Test_NBS/Temp
set success_path $direct/Test_NBS/$success_directory
...
set input_trees [lsort -dictionary [glob *txt]]
