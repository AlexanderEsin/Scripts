...
genList_dir	<- file.path(master, "Staph_genomes", "Genome_lists")
toKeep_tbl		<- read_tsv(file.path(genList_dir, "coreToKeep.tsv"))
accAss_tax_tbl	<- read_tsv(file.path(genList_dir, "core_AccAssTaxid_table.tsv"))
