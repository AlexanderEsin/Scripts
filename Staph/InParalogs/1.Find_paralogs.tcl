...
set cross_in_files	[glob $cross_path/IN_grp/*]
foreach file $cross_in_files {
	file copy -force $file $input_path
	if {[file extension $file] eq ".gz"} {
		exec gunzip $input_path/[file tail $file]
	}
}
set cross_db_files	[glob $cross_path/DB_grp/*]
foreach file $cross_db_files {
	file copy -force $file $db_path
	if {[file extension $file] eq ".gz"} {
		exec gunzip $db_path/[file tail $file]
	}
}
