...
p_load(tidyverse, fs, ape, RSQLite)
...
direct			<- file.path("/Users/aesin/Desktop/Staph/Prefilter/Staphylococcus/")
...
dir_create(c(out_tax_dir, out_bin_dir))

## ----------------------------------------------- ##


## Open All_prot_db database
database_path	<- "/Users/aesin/Desktop/Staph/All_prot_db_new"
