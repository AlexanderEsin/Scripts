...
set acc_ass_file	$consens_dir/Acc_ass_list.txt
# First line here is a header
set acc_ass_list	[lrange [split [string trim [openfile $acc_ass_file]] \n] 1 end]

set all_taxids		{}
foreach row $acc_ass_list {
	set taxid	[lindex [split $row " "] 0]
